...
Circle::Circle(int rad, sf::Color clr, sf::Vector2f pos) : Figure(rad * 2, rad * 2, clr, pos)
{
	radius = rad;
	vertex_count = 36;
	initialize_vertices();
...
{
	return "1-" + std::to_string(radius) + "-" + std::to_string(default_color.r) + "," + std::to_string(default_color.g) + "," + std::to_string(default_color.b)
